...
namespace UE
{
	namespace Geometry
	{
		...
		class TMultiTask2MeshSimplifier : public FMeshRefinerBase
		{
		public:
			...
			*/
			...
			/** if true, we force to keep boundary vertices on boundary. You probably want this. */
			bool bForcePreserveBoundaryShape = true;
			...
			TMultiTask2MeshSimplifier(FDynamicMesh3* m) : FMeshRefinerBase(m)
			{
		...
		protected:
			...
			TMultiTask2MeshSimplifier()		// for subclasses that extend our behavior
			{
			}
