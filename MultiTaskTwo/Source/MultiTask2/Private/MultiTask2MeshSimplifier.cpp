...
QuadricErrorType TMultiTask2MeshSimplifier<QuadricErrorType>::ComputeFaceQuadric(const int tid, FVector3d& nface, FVector3d& c, double& Area) const
{
...
template<>
FAttrBasedQuadricErrord TMultiTask2MeshSimplifier<FAttrBasedQuadricErrord>::ComputeFaceQuadric(const int tid, FVector3d& nface, FVector3d& c, double& Area) const
{
	// compute the new quadric for this tri.
	Mesh->GetTriInfo(tid, nface, Area, c);
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::InitializeTriQuadrics()
{
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::InitializeSeamQuadrics()
{
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::InitializeVertexQuadrics()
{
...
template <typename QuadricErrorType>
QuadricErrorType TMultiTask2MeshSimplifier<QuadricErrorType>::AssembleEdgeQuadric(const FDynamicMesh3::FEdge& edge) const
{
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::InitializeQueue()
{
...
template <typename QuadricErrorType>
FVector3d TMultiTask2MeshSimplifier<QuadricErrorType>::OptimalPoint(int eid, const FQuadricErrorType& q, int ea, int eb)
{
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::UpdateNeighborhood(const FDynamicMesh3::FEdgeCollapseInfo& collapseInfo)
{
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::Precompute(bool bMeshIsClosed)
{
	bHaveBoundary = false;
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::DoSimplify()
{
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::SimplifyToTriangleCount(int nCount)
{
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::SimplifyToVertexCount(int nCount)
{
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::SimplifyToEdgeLength(double minEdgeLen)
{
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::SimplifyToMaxError(double MaxError)
{
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::SimplifyToMinimalPlanar(
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::FastCollapsePass(double fMinEdgeLength, int nRounds, bool MeshIsClosedHint)
{
	if (Mesh->TriangleCount() == 0)    // badness if we don't catch this...
	{
		return;
...
template <typename QuadricErrorType>
bool TMultiTask2MeshSimplifier<QuadricErrorType>::CanCollapseEdge(int edgeID, int a, int b, int c, int d, int t0, int t1, int& collapse_to) const
{
...
template <typename QuadricErrorType>
ESimplificationResult TMultiTask2MeshSimplifier<QuadricErrorType>::CollapseEdge(int edgeID, FVector3d vNewPos, FDynamicMesh3::FEdgeCollapseInfo& collapseInfo, int32 RequireKeepVert)
{
	...
	if (bPreserveBoundaryShape && bHaveBoundary)
	{
		...
		if (bForcePreserveBoundaryShape && IsBoundaryVertex(a) && IsBoundaryVertex(b))
		{
			return ESimplificationResult::Ignored_Constrained;
		}
...
template <typename QuadricErrorType>
bool TMultiTask2MeshSimplifier<QuadricErrorType>::CheckIfCollapseWithinGeometricTolerance(int vKeep, int vRemove, const FVector3d& NewPosition, int tc, int td)
{
...
template <typename QuadricErrorType>
bool TMultiTask2MeshSimplifier<QuadricErrorType>::RemoveIsolatedTriangle(int tID)
{
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::FullProjectionPass()
{
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::ApplyToProjectVertices(const TFunction<void(int)>& apply_f)
{
	for (int vid : Mesh->VertexIndicesItr())
	{
		apply_f(vid);
...
template <typename QuadricErrorType>
void TMultiTask2MeshSimplifier<QuadricErrorType>::ProjectVertex(int vID, IProjectionTarget* targetIn)
{
	FVector3d curpos = Mesh->GetVertex(vID);
...
template <typename QuadricErrorType>
FVector3d TMultiTask2MeshSimplifier<QuadricErrorType>::GetProjectedCollapsePosition(int vid, const FVector3d& vNewPos)
{
	if (Constraints)
	{
...
template<>
void TMultiTask2MeshSimplifier<FAttrBasedQuadricErrord>::OnEdgeCollapse(int edgeID, int va, int vb, const FDynamicMesh3::FEdgeCollapseInfo& collapseInfo)
{
